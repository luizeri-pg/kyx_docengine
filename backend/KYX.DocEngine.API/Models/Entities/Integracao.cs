...
public class Integracao
{
    ...
    [Required]
    [Column("tipo")]
    public string Tipo { get; set; } = string.Empty; // email, sms, whatsapp
    ...
    [Required]
    [Column("provedor")]
    public string Provedor { get; set; } = string.Empty; // gmail, twilio, etc
    ...
    [Required]
    [Column("credenciais")]
    public string Credenciais { get; set; } = "{}"; // JSON criptografado
