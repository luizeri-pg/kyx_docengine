...
/// <summary>
/// Mapeia o modelo EF às tabelas padrão KYX/Notify (<c>tb_*</c>).
/// SQL idempotente: seguro quando as tabelas já existem (mesmo conteúdo que <c>docs/sql/plataforma-kyx-tabelas.sql</c>).
/// </summary>
public partial class MapPlataformaKyxTabelas : Migration
{
    ...
    {
        // Tabelas partilhadas com outros serviços: não remover em rollback automático.
    }
}
